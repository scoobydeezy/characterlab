...
const output='docs/planning/SELECTED_BODY_CONTEXT_REVIEW_REV2.json';assert(!fs.existsSync(output));
...
const faults=[
  ...
  [
    ...
    "src/test/concernSignificanceSourceComposition.test.ts",
    "op.selected.selectionId);return acquisition;",
