...
const output='docs/planning/COGNITIVE_MATH_REFERENCE_COMPARISON_REV1.json';assert(!fs.existsSync(output));
const paths=['src/campaign2/cognitiveMath.ts','src/campaign2/cognitiveCodecs.ts','reference/src/model/diceCompiler.ts','reference/src/model/identity.ts','reference/src/kernel/evidenceOverlap.ts','scripts/compare-cognitive-math-reference.mjs'];
