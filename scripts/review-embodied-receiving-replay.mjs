...
const output='docs/planning/EMBODIED_RECEIVING_REPLAY_REV1.json';assert(!fs.existsSync(output));
const folder='docs/planning/embodied-receiving-execution-rev3',cohort='docs/planning/campaign3-embodied-receiving-model-rev1',executions=JSON.parse(fs.readFileSync(folder+'/REVIEW.json')),freeze=JSON.parse(fs.readFileSync(cohort+'/FREEZE.json'));
