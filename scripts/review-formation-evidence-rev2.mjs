...
const output='docs/planning/FORMATION_EVIDENCE_REVIEW_REV2.json';assert(!fs.existsSync(output));
...
["visual-zero-positive","src/campaign3/positiveSpatialCandidate.ts","src/test/visualFormationEvidence.test.ts","filter(r=>r.status==='Positive')","filter(r=>r.status!=='UnavailableAllocation')","VF-B"]];const results=[];
