...
const inherited={WorldEventTruth:'existing210',ReserveAnchor:'existing454',ReserveReplenishmentResult:'existing479',TaskConcernResponse:'existing386',PerceptualReferentId:'existing212',PerceptualEventReferentId:'existing213',PreRecognitionSemanticExperience:'existing227',EmbodiedLevelObservation:'existing461',EmbodiedSample:'existing461/463',CanonicalRecordSchemaRef:'existing254',StatePathPattern:'existing149',CurrentDetectionId:'existing214',CurrentEventDetectionId:'existing215',PerceptualTrackTransition:'existing217',PerceptualEventTransition:'existing219',EventRoleEvidence:'existing223',PerceivedBindingEvidence:'existing224',CausalRoleEvidence:'existing240',AttentionUnitKey:'existing530',SelectedEvidenceView:'existing534'};
...
fs.writeFileSync(output,JSON.stringify({version:'ga-identity-role-closure/0.10-draft',status:'SYMBOLIC ROLE CROSSWALK; PUBLIC COMPILER AND ALLOCATION OPEN',recordCount:records.length,positions,boundaries,stateMapKeyRoles,stateMapKeyDisposition:'Symbolic six scalar new-root key roles plus composite physical key recursion; actual compiler and inherited root coverage remain separate.',sources:[...inputs,'docs/planning/GA_IDENTITY_ROLE_CLOSURE_REV10.md','scripts/build-ga-identity-role-closure-rev10.mjs'].map(fp)},null,2)+'\n');
