...
const output='docs/planning/embodied-receiving-execution-rev1';assert(!fs.existsSync(output));
...
try{
 ...
 const cases=[
  ...
  {name:'execution-blocked',model:'execution-blocked'},{name:'quiet',model:'quiet'},{name:'auto',model:'auto'},
