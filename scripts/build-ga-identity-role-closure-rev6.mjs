...
fs.writeFileSync(output,JSON.stringify({version:'ga-identity-role-closure/0.6-draft',status:'SYMBOLIC ROLE CROSSWALK; PUBLIC COMPILER AND ALLOCATION OPEN',recordCount:records.length,positions,boundaries,stateMapKeyRoles,stateMapKeyDisposition:'Symbolic six scalar new-root key roles plus composite physical key recursion; actual compiler and inherited root coverage remain separate.',sources:[...inputs,'docs/planning/GA_IDENTITY_ROLE_CLOSURE_REV6.md','scripts/build-ga-identity-role-closure-rev6.mjs'].map(fp)},null,2)+'\n');
