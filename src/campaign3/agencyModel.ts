/** agency-public/0.3-candidate: finite recipes and disjoint registered owners. */
...
export const VERSION = 'agency-public/0.3-candidate';
...
export const STAGES = [['context',40],['probe-a',40],['probe-b',40],['raw',51],['reasons',52],['decision',60],['intent',70],['expression',80],['plan',90],['attempt',100],['execution',110],['report',110],['observe-a',120],['observe-b',120],['evidence-a',130],['evidence-b',130],['history',140],['update-a',140],['update-b',140]] as const;
