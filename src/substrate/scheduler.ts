...
export type SchedulerFailureCode =
  ...
  | 'COGNITIVE_STAGE_VIOLATION'
  | 'IDENTITY_TARGET_COLLISION'
  | 'IDENTITY_EVIDENCE_ALREADY_APPLIED'
  | 'IDENTITY_EVIDENCE_ORDER_VIOLATION'
  | 'IDENTITY_EVIDENCE_LIMIT_EXCEEDED'
  ...
  | 'ADAPTATION_MUTATION_DIFF_VIOLATION'
