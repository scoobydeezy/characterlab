...
|---|---|---|---|---|
| `ATTN-001` perceptual attention and encoding salience | `P1` | perception/attention, encoding and retrieval | General capacity/attention/salience and affect-biased retrieval experiments; not the already qualified task slice | Preserve MEC-005 CONTROL+CONTRACT, MEC-007 CONTROL, CTL-004 and RET-001. Specify permitted evidence, selection/capacity, residual-pool and budget alternatives, observer-relative role factors and no flat-tag learning shortcut before implementation. Keep permission, active selection, encoding strength and later access distinct; residual-pool salience is a control. See Campaign3 readiness, ATTENTION intake and CAMPAIGN3_BODY_RESEARCH_FRONTIER.md. |
| `EMB-001` body kinetics, interoception and embodied motive | `P1` | physiology/interoception/Needs | General biology and embodied motive receiving; not existing REG arithmetic or probe qualification | OPEN parent. [Bounded whole symbolic shape accepted](EMBODIED_RESERVE_SHAPE_ACCEPTANCE.md), 2026-09-10: reserve/current finite-level observation/support-only SEM/option-free pressure/external replenishment. Exact 15-file manifest, 32 records/128 fields; 76 implementation vectors FROZEN, NOT PASSED and EMB-M..O deferred. [Permanent allocation](EMBODIED_RESERVE_PERMANENT_ALLOCATION.md) frozen: records453..484, namespace1142,43 members. Complete model/content/role packaging precedes execution. No new runtime qualification or corpus member. Non-task action knowledge, reason keys, cross-family receiving, BODY+MULTISOURCE and final Need ownership remain open; CTL-001 retained as stored-meter control. Earlier draft revisions and scoped component receipts remain preserved in the accepted packet and planning history. |
