# Campaign 3 coverage after bounded EMB

2026-09-11. Planning reconciliation, not corpus promotion or a new reduction verdict.
The governing corpus remains `corpus/0.27.0` and its accepted digest
`3cb09115d90485d5975968ffca419a4960a398326b6b6339a5b1e8e8fdcec276`.
BODY, MULTISOURCE and ATTENTION remain local intake labels, not allocated members.
...
|---|---|---|
| BODY: equal levels, different kinetics | EMB-A/B; exact integration and public baseline/slower trajectories | Bounded distinction witnessed. Not biological calibration. |
| BODY: hidden aliases and observer resolution | EMB-E/F/H; receiving hidden71/hidden79 and fine35/coarse35 | Bounded observer-safe equality and resolution effects witnessed through choice. |
| BODY: delayed exposure and motive | EMB-C/D/J/L; external delivery, later samples and receiving pressure/action path | Ingredients execute in qualified profiles. The intake's complete matched longitudinal comparison still needs one exact fixture/comparison specification. |
| BODY: stored-meter and authored-reference comparisons | Stored-level fault control; CTL-001 and REG remain distinct preserved controls | No matched public three-model comparison established. An immutable authored reference is not a body. |
| BODY: adaptation/learned-evidence trace | Body state, observer evidence and motive are separate; receiving has no learning writes | Do not reinterpret current support-only SEM as learned history. Adaptation/learning applicability must be explicit in a successor fixture; no invented zero-valued adaptation lane. |
| MULTISOURCE: different source families and shared option | ER-A/E/F; task and body grounds, probability221/256 versus1/2 after source removal | Former absence of a second family is closed within this domain. |
