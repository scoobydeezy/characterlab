/** personstate-public/0.1-candidate: choice, delivery and three private owners. */
...
export const VERSION='personstate-public/0.1-candidate',HOLDERS=['target','a','b'].map(n=>sid(1000,'observer/personstate/'+n));
...
export const STAGES=[['source',0],['observe-private',10],['cue-a',10],['cue-b',10],['learn-private',30],['learn-cue-a',30],['learn-cue-b',30],['context',40],['appraise-a',50],['appraise-b',50],['raw',51],['reasons',52],['decision',60],['intent',70],['expression',80],['plan',90],['attempt',100],['execute',110],['observe-a',120],['observe-b',120],['learn-a',140],['learn-b',140]] as const;
