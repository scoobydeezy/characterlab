...
async function run(name:keyof ReturnType<typeof cases>='main',law=1,pressure=2){const s=await setup(name,law,pressure,severity);while(await s.r.settle()){}return s;}
