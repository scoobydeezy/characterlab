...
const workerRoot='docs/planning/reliance-history-public-workers-rev1';
const p='docs/planning/',planPath=p+'RELIANCE_HISTORY_PUBLIC_PLAN_REV1.json',resultPath=p+'RELIANCE_HISTORY_PUBLIC_RESULT_REV1.json';
