...
export const CASES=[
 {name:'acquiredAbsent',counts:[1,1,1,1],baseline:80,support:0,other:false,wrong:false},
 {name:'naiveAbsent',counts:[0,0,0,0],baseline:80,support:0,other:false,wrong:false},
 {name:'acquiredPresent',counts:[1,1,1,1],baseline:80,support:4,other:false,wrong:false},
 {name:'naivePresent',counts:[0,0,0,0],baseline:80,support:4,other:false,wrong:false},
 {name:'spaced',counts:[1,0,1,0],baseline:80,support:0,other:false,wrong:false},
 {name:'acquiredShortfall',counts:[1,1,1,1],baseline:78,support:0,other:false,wrong:false},
 {name:'naiveShortfall',counts:[0,0,0,0],baseline:78,support:0,other:false,wrong:false},
 {name:'otherLeaves',counts:[1,1,1,1],baseline:80,support:0,other:true,wrong:false},
 {name:'otherKey',counts:[1,1,1,1],baseline:80,support:0,other:false,wrong:true},
] as const;
