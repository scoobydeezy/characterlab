...
| Evidence overlap | reason-evidence-coverage/0.1-candidate | Qualified aggregate-coverage component | [Bounded task/body independent grounds and within-body duplication qualified](CAMPAIGN3_POST_EMB_COVERAGE.md); cross-family shared-fact/sign/normalization corpus comparisons remain blocked |
