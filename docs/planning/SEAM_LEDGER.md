...
**Current routing, 2026-09-20:** [state index](CURRENT.md), [public multisource qualification](CAMPAIGN3_MULTISOURCE_PUBLIC_QUALIFICATION.md), and [verdict ledger](VERDICT_LEDGER.md). Corpus0.29.0 has21 members; bounded GA and the bounded public multisource experiment are complete; zero owner rulings open. Counters733/0. General receiving laws remain unresolved; RO-C3-001 is conditional after its immediate public-source debt is discharged.
