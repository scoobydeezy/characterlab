...
const p='docs/planning/',planPath=p+'AGENCY_PUBLIC_PLAN_REV1.json',resultPath=p+'AGENCY_PUBLIC_RESULT_REV1.json';
...
try {
 ...
 if(process.argv.includes('--plan')) {
  ...
  const paths=['docs/formal/AGENCY_PUBLIC_CONTRACT.md','docs/formal/AGENCY_PUBLIC_ALLOCATION_TABLE.json',p+'campaign3-agency-model-rev1/FREEZE.json',...['Codecs','Model','Math','Runtime','Factory'].map(n=>'src/campaign3/agency'+n+'.ts'),'src/test/agencyFixtures.ts','src/test/agencyPublic.test.ts','scripts/qualify-agency-public.mjs'];
